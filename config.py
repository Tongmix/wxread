...
READ_MIN_INTERVAL = int(os.getenv('READ_MIN_INTERVAL') or 10)
READ_MAX_INTERVAL = int(os.getenv('READ_MAX_INTERVAL') or 30)
...
data = {
    ...
    'c': '4c5320902b64c5bde74a8bf',
    'ci': 97,
    'co': 13184,
    'sm': '在太阳系联邦的首都“地球一号”太空城，在',
    'pr': 74,
    'rt': 6,
    'ts': 1742268656868,
    'rn': 410,
    'sg': '98deea6d7b4a4843386e9012804dd2fb656ba5721ea5705ffb12b20dc954dd17',
    'ct': 1742268656,
    'ps': '85e325907a627dafg01984b',
    'pc': '2d8326407a627db0g010738',
}
